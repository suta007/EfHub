...
local v_u_6 = v4:Create(script.Parent.Parent.OPEN_BUTTON, v5, {
	["Size"] = UDim2.new(1, 0, 1, 0)
})
local v_u_7 = v4:Create(script.Parent.Parent.OPEN_BUTTON, v5, {
	["Size"] = UDim2.new(0.9, 0, 0.9, 0)
})
script.Parent.Parent.OPEN_BUTTON.Size = UDim2.new(0.9, 0, 0.9, 0)
