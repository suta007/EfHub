...
function v9.OnStarted(p37)
	...
	local v_u_38 = game.Workspace.Interaction:WaitForChild("AlienStand", 300):WaitForChild("UFO", 300)
	if v_u_38 then
...
function v9.OnStopped(_)
	-- upvalues: (copy) v_u_8
	local v45 = v_u_8:WaitForChild("Frame", 30):WaitForChild("ScrollingFrame", 30):WaitForChild("UFOShardsFrame", 30)
	if v45 then
		v45.Visible = false
	end
end
