...
local v_u_4 = require(v1.Modules.GuestEventServices.CommandRequestController)
v_u_4.CommandRequestMessageCreated:Connect(function(p_u_5)
	...
	local v8 = v_u_3
	local v9 = {
		["Text"] = ("%* wants to use: %*!"):format(v6, p_u_5.RawText),
		["EnabledComponents"] = {
			["OptionSet"] = true,
			["Confirm"] = true,
			["Decline"] = true,
		...
		["OnConfirm"] = function()
			...
			v_u_4:AuthorizeCommand(p_u_5.MessageId)
		end,
		["OnDecline"] = function()
			-- upvalues: (ref) v_u_4, (copy) p_u_5
			v_u_4:DenyCommand(p_u_5.MessageId)
		end
	}
