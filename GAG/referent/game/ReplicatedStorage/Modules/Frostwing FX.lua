...
v1:GetInstanceAddedSignal("Frostwing"):Connect(v12)
v1:GetInstanceRemovedSignal("Frostwing"):Connect(function(p13)
	-- upvalues: (copy) v_u_5
	if v_u_5[p13] then
		v_u_5[p13]:Stop()
	end
...
local v_u_14 = v_u_4
for _, v15 in v1:GetTagged("Frostwing") do
	v12(v15)
end
local v_u_16 = nil
