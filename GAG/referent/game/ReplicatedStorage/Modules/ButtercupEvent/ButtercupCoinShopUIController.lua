...
local v_u_8 = require(v2.Data.ButtercupCoinData)
local v_u_9 = v1.LocalPlayer.PlayerGui.ButtercupCoinShop_UI
local v_u_18 = {
	["Start"] = function(_)
		...
		v_u_3:GetPathSignal("SpecialCurrency/ButtercupCoins"):Connect(function()
			-- upvalues: (ref) v_u_18
			v_u_18:Update()
		end)
	end,
	...
	["Update"] = function(_)
		...
		v_u_9.Shadow.Frame.Header.CoinCounter.Label.Text = "Coins: " .. v_u_5.Comma(v17.SpecialCurrency.ButtercupCoins)
	end
}
