...
local v_u_6 = {
	[script.JandelsLaststand] = "Instance",
	[script.JandelStampede] = "Instance",
	[script.JandelBeanstalk] = "Instance",
	[script.JandelFestival] = "Instance",
	[script.JhaiWedding] = "Instance",
	[script.Easter2026] = "Instance",
	[script.JandelGalaxy] = "Instance",
	[script.DiscoApocalypse] = "Instance",
