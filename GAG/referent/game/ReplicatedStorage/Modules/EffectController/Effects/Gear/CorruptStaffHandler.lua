...
return {
	["Create"] = function(p5)
		...
		p5.Cache[v6] = {}
		local v7 = p5.Parameters.CorruptStaffType
		local v8 = p5.Parameters.CorruptStaffCFrame
		local v9 = v_u_1.ObjectModels:FindFirstChild(v7)
		if v9 then
			local v10 = v9:Clone()
			if v9 then
				v_u_2:AddTag(v10, "CorruptStaff")
	...
	["Destroy"] = function(p19)
		...
		if v_u_21 then
			v_u_2:RemoveTag(v_u_21, "CorruptStaff")
			...
			local v24 = {
				...
				["StepType"] = "Heartbeat",
				["Goal"] = {
					["CFrame"] = p19.Parameters.CorruptStaffCFrame * CFrame.new(0, 3, 0)
				}
			}
