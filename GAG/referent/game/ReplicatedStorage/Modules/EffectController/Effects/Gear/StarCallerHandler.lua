...
return {
	["Create"] = function(p5)
		...
		p5.Cache[v6] = {}
		local v7 = p5.Parameters.StarCallerType
		local v8 = p5.Parameters.StarCallerCFrame
		local v9 = v_u_1.ObjectModels:FindFirstChild(v7)
		if v9 then
			local v10 = v9:Clone()
			if v9 then
				v_u_2:AddTag(v10, "StarCaller")
	...
	["Destroy"] = function(p19)
		...
		if v_u_21 then
			v_u_2:RemoveTag(v_u_21, "StarCaller")
			...
			local v24 = {
				...
				["StepType"] = "Heartbeat",
				["Goal"] = {
					["CFrame"] = p19.Parameters.StarCallerCFrame * CFrame.new(0, 3, 0)
				}
			}
