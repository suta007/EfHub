...
return {
	["Create"] = function(p5)
		...
		p5.Cache[v6] = {}
		local v7 = p5.Parameters.TranquilStaffType
		local v8 = p5.Parameters.TranquilStaffCFrame
		local v9 = v_u_1.ObjectModels:FindFirstChild(v7)
		if v9 then
			local v10 = v9:Clone()
			if v9 then
				v_u_2:AddTag(v10, "TranquilStaff")
				v10:SetAttribute("Staff_ID", v6)
	...
	["Destroy"] = function(p19)
		...
		if v_u_21 then
			v_u_21 = p19.Cache[v20].Staff
		end
		if v_u_21 then
			v_u_2:RemoveTag(v_u_21, "TranquilStaff")
			...
			local v24 = {
				...
				["StepType"] = "Heartbeat",
				["Goal"] = {
					["CFrame"] = p19.Parameters.TranquilStaffCFrame * CFrame.new(0, 3, 0)
				}
			}
