...
return {
	["Create"] = function(p5)
		...
		p5.Cache[v6] = {}
		local v7 = p5.Parameters.FairyTargeterType
		local v8 = p5.Parameters.FairyTargeterCFrame
		local v9 = v_u_1.ObjectModels:FindFirstChild(v7)
		if v9 then
			local v10 = v9:Clone()
			if v9 then
				v_u_2:AddTag(v10, "FairyTargeter")
				v10:SetAttribute("CALLER_ID", v6)
	...
	["Destroy"] = function(p19)
		...
		if v_u_21 then
			v_u_21 = p19.Cache[v20].Caller
		end
		if v_u_21 then
			v_u_2:RemoveTag(v_u_21, "FairyTargeter")
			...
			local v24 = {
				...
				["StepType"] = "Heartbeat",
				["Goal"] = {
					["CFrame"] = p19.Parameters.FairyTargeterCFrame * CFrame.new(0, 3, 0)
				}
			}
			...
			v_u_3:PlaySound(v_u_4.Tools.Generic.PlaceableStaffDestroy, v25, nil, Staff.PrimaryPart)
