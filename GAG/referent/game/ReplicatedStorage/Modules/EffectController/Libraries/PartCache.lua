...
function v_u_2.new(p4, p5, p6)
	...
	for _ = 1, v7 do
		...
		v17.CFrame = v_u_3
		v17.Anchored = true
		v17.TopSurface = Enum.SurfaceType.Smooth
		v17.BottomSurface = Enum.SurfaceType.Smooth
...
function v_u_2.GetPart(p18)
	...
	if #p18.Open == 0 then
		...
		for _ = 1, p18.ExpansionSize do
			...
			v27.CFrame = v_u_3
			v27.Anchored = true
			v27.TopSurface = Enum.SurfaceType.Smooth
			v27.BottomSurface = Enum.SurfaceType.Smooth
