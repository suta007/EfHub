...
local v_u_6 = v1.LocalPlayer:WaitForChild("PlayerGui"):WaitForChild("CosmeticUI"):WaitForChild("RotationXIcon")
...
function v_u_11.Toggle(_, p13)
	...
	v_u_11.Active = p13
	v_u_12 = v_u_3:GetMouseLocation().Y
...
v2.RenderStepped:Connect(function()
	...
	if v_u_11.Active then
		local v16 = v_u_3:GetMouseLocation().Y
		...
		v_u_7.Position = UDim2.fromScale(0.5, 0.5) + UDim2.fromOffset(0, v19)
	end
end)
local v_u_22 = {
