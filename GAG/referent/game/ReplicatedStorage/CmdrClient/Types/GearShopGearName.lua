...
local v_u_3 = {}
for v4, v5 in require(v1.Data.GearShopData).Gear do
	if v5.StockAmount[2] ~= 0 then
...
local v_u_10 = {
	...
	["Validate"] = function(p7)
		return #p7 > 0, "No gears could be found."
	end,
...
return function(p11)
	...
	p11:RegisterType("gearshopgearname", v_u_10)
end