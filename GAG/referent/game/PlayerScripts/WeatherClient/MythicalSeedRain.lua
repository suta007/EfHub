...
local function v_u_60()
	...
	v_u_7:Create(v_u_3, TweenInfo.new(4), {
		...
		["Contrast"] = 0.05,
		["Saturation"] = 0.1,
		["TintColor"] = Color3.fromRGB(225, 195, 255)
	}):Play()
	...
	v16.Parent = game.Workspace.WeatherVisuals.Mythical
	local v_u_17 = {}
	local v_u_18 = {}
	local v_u_19 = {}
	local v_u_20 = 0
	v_u_14:Add(v_u_6.Heartbeat:Connect(function(p21)
		...
		if workspace:GetAttribute("MythicalSeedRain") then
			v_u_20 = v_u_20 + p21
							...
							if v25 then
								...
								if v27 then
									...
									if v33 >= 1 then
										...
										v38.Parent = workspace.WeatherVisuals.Mythical
	...
	local function v_u_53(p45, p46)
		...
		if game.Workspace:GetAttribute("MythicalSeedRain") then
			local v47 = math.random(600, 700)
			local v48 = p45 + Vector3.new(0, v47, 0)
			local v_u_49 = game.Workspace.WeatherVisuals.Mythical:FindFirstChild(p46)
			if v_u_49 then
				...
				v_u_14:Add(v_u_49:GetAttributeChangedSignal("Activated"):Connect(function()
					...
					if v_u_49:GetAttribute("Activated") == game.Players.LocalPlayer.Name then
						...
						v52.Parent = workspace.WeatherVisuals.Mythical
						v52.Looped = true
	...
	v_u_14:Add(game.ReplicatedStorage.GameEvents.MythicalSeedRainEvent.OnClientEvent:Connect(function(p54, p55)
	...
	repeat
		task.wait()
	until v_u_2 == false
	for _, v56 in game.Workspace.WeatherVisuals.Mythical:GetChildren() do
...
workspace:GetAttributeChangedSignal("MythicalSeedRain"):Connect(function()
