...
local function v_u_26(p13)
	...
	if not (v_u_11 and v_u_11.Parent) then
		return
	end
...
local function v_u_71(p57)
	...
	if v_u_4 == true then
		...
		if p57 then
			...
			game.TweenService:Create(v_u_9, TweenInfo.new(1), {
				["Volume"] = 0.1
			}):Play()
			...
			for _, v68 in v66:GetDescendants() do
				if v68:IsA("Beam") then
					...
					v68.Width0 = 0
					v68.Width1 = 0
					game.TweenService:Create(v68, TweenInfo.new(4), {
						["Width0"] = v69,
						["Width1"] = v70
					}):Play()
					...
					for _, v_u_77 in v_u_76:GetDescendants() do
						if v_u_77:IsA("Beam") then
							task.spawn(function()
								...
								game.TweenService:Create(v_u_77, TweenInfo.new(4), {
									["Width0"] = 0,
									["Width1"] = 0
								}):Play()
							end)
